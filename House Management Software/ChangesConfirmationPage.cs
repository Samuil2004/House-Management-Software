...
{
    public partial class ChangesConfirmationPage : Form
    {
        ...
        public ChangesConfirmationPage(User loggedInUser, UserProfile userProfile, DataManager dataManager, string username, string phoneNumber, string password)
        {
            InitializeComponent();
